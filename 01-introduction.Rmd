...
A covenant is an agreement that:

-   establishes (or re-establishes) a community;
-   defines who is a member of the community;
-   identifies what it is that binds the community together -- e.g., divine command, blood relations, shared allegiance to a sovereign power, voluntary association, ...
-   identifies
    -   the *terms* of association,
    -   the shared *values*,
    -   [Maybe] some foundational laws and/or social canons that members of the community proclaim, accept, and agree to live by

(This is a definition based *outcomes*.)

## Subcategories of covenants

### Divine command; Dominionism

### Strongman; Authoritarian

### Tribal affiliation

### Enlightenment covenant

The EC, based on autonomy, is that the role of government is to create and maintain and enhance the conditions of autonomy so that humans can flourish.

Assessment criteria for proposed laws, rules, etc.: Will this [X] enhance human flourishing as autonomous persons?

### Comments and comparisons

Non-enlightenment covenantal structures will tend to exclude autonomous expressions of life (e.g., gay marriages).

Move to replace "autonomy" with "dignity"; then marry "dignity" to authority.

*Autonomy* $\neq$ *satisfaction of desire.*
